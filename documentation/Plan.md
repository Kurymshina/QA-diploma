...
2. Покупка тура валидной картой с помощью кнопки "Купить" со статусом "DECLINED": *Ожидаемый результат: Появление всплывающего окна "Ошибка! Банк отказал в проведении операции", запись со статусом "DECLINED" в базе данных.*
